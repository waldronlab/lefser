...
# data(zeller14)
#
# View(data.frame(rownames(zeller14)))
# # Aquabirnavirus_unclassified
#
# zeller14 <- zeller14[, zeller14$study_condition != "adenoma"]
# tn <- get_terminal_nodes(rownames(zeller14))
# zeller14 <- zeller14[tn,]


# data.frame(grep("GCF_", rownames(zeller14), value = TRUE, invert = TRUE)) |> View()
#
# zeller14 <- relativeAb(zeller14)
#
